...
**Primary archive (citable, permanent):** the essential files needed to run
this replication code are archived on Zenodo:
[https://doi.org/10.5281/zenodo.20754919](https://doi.org/10.5281/zenodo.20754919).
Download from there and place the files in `data/` before running the `.do` scripts.

**Full working file set (Google Drive):** the complete set of intermediate
and working files (including large files not archived on Zenodo) remains
available at
https://drive.google.com/drive/folders/1oTmV9N5PLXAQY6P8WeIX6znzgbLpp9FQ.
Most users replicating the paper's headline results only need the Zenodo
files; the additional Drive files are working/intermediate outputs that can
be regenerated by running the `.do` scripts.
